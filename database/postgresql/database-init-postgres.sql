...
CREATE DATABASE iomete_mcp_db;
CREATE DATABASE iomete_prefect_db;
...
GRANT ALL PRIVILEGES ON DATABASE iomete_mcp_db TO iomete_user;
GRANT ALL PRIVILEGES ON DATABASE iomete_prefect_db TO iomete_user;
